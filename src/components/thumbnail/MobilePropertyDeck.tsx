...
export function MobilePropertyDeck({ isOpen, onClose, title, children }: MobilePropertyDeckProps) {
    ...
    return (
        <div
            className={cn(
                "fixed bottom-16 left-0 right-0 z-40 flex flex-col rounded-t-[20px] bg-surface/95 backdrop-blur-2xl border-t border-white/10 shadow-2xl transition-all duration-300 ease-out transform",
